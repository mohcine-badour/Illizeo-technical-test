...
const initialNotes = [
  ...
  {
    id: 3,
    content: 'Ideas for the team building event:\n- Escape room\n- Cooking class\n- Outdoor adventure\n- Board game night',
    author: 'Emily Davis',
  ...
  {
    id: 5,
    content: 'Client feedback summary: Overall positive response to the new UI design. Minor adjustments needed on mobile navigation.',
